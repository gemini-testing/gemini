...
2. [Selenium Grid](https://code.google.com/p/selenium/wiki/Grid2) - для тестирования в различных браузерах.
...
В качестве ключей в `browsers` используются уникальные идентификаторы браузеров (выбираются пользователем произвольно), а в качестве значения – [DesiredCapabilites](https://code.google.com/p/selenium/wiki/DesiredCapabilities) данного браузера.

### Другие варианты настройки
[Подробнее](https://github.com/jk708/gemini/blob/restructuring-docs/doc/config.ru.md) о структуре конфигурационного файла.
...
[Подробнее](https://github.com/jk708/gemini/blob/restructuring-docs/doc/commands.ru.md) о работе с командной строкой и доступных аргументах.

## GUI

Вместо командной строки можно использовать графический интерфейс `Gemini`. Он располагается в пакете 
