...
function prepareViewData(runner, reporterOptions) {
    return new Promise((resolve) => {
        var model = new ViewModel(runner.config, reporterOptions);
...
module.exports = function htmlReporter(runner, reportPath, reporterOptions) {
    reporterOptions = reporterOptions || {};
    const generateReportPromise = Promise.all([prepareViewData(runner, reporterOptions), prepareImages(runner, reporterOptions)])
