const report = () => {
    ...
    function expandAll() {
        ...
        forEach.call(document.querySelectorAll('.section'), (section) => section.classList.remove('section_collapsed'));
    }

    function collapseAll() {
        forEach.call(document.querySelectorAll('.section'), (section) => section.classList.add('section_collapsed'));
    }
    ...
    function expandErrors() {
        ...
        forEach.call(document.querySelectorAll('.section'), (section) => {
    ...
    function handleColorSwitch(target, sources) {
        ...
        forEach.call(imageBox.classList, (cls) => {
    ...
    function handleRetriesSwitch(target) {
        ...
        function switch_(elem, selector) {
            forEach.call(elem.children, (item) => {
    ...
    function bodyClick(e) {
        ...
        if (target.classList.contains('cswitcher__item')) {
            handleColorSwitch(
                target,
                filter.call(target.parentNode.childNodes, (node) => node.nodeType === Node.ELEMENT_NODE)
            );
        }
    ...
    function findClosest(context, cls) {
        let context = context = context.parentNode;
        while (context) {
    ...
    function loadLazyImages(elem, selector) {
        forEach.call(elem.querySelectorAll(selector), (img) => {
