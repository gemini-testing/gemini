...
module.exports = inherit({
    ...
    _waitElementAction: (method, selector, options) => {
        ...
        this._pushAction(method, (browser) =>
            browser.waitForElementByCssSelector(selector, options.asserter, timeout)
                .catch(() => {
    ...
    doubleClick: (element, button) => {
        ...
        this._pushAction(this.doubleClick, (browser) =>
            findElement(element, browser)
                .then(() => browser.moveTo(element))
                .then(() => browser.doubleClick(element, button))
        );
        return this;
    },
    ...
    sendKeys: (element, keys) => {
        ...
        if (typeof keys === 'undefined' || keys === null) {
            ...
            action = (browser) =>
                findElement(element, browser).then((element) => browser.type(element, keys));
        }
