...
module.exports = class InsistentSuiteRunner extends SuiteRunner {
    ...
    _initSuiteRunner() {
        ...
        this._handleEvent(runner, RunnerEvents.ERROR, (e) => e instanceof NoRefImageError);
        this._handleEvent(runner, RunnerEvents.TEST_RESULT, (r) => r.equal);
    ...
    _handleError(e) {
        ...
        this._emit(RunnerEvents.ERROR, e);
        return false;
    }
    ...
    _submitForRetry(e) {
        ...
        this._emit(RunnerEvents.RETRY, _.extend(e, {attempt: this._retriesPerformed, retriesLeft}));
        return true;
    }
};
