...
var RegularSuiteRunner = inherit(SuiteRunner, {
    ...
    _doRun: function(captureProcessor) {
        ...
        return this._browserAgent.getBrowser()
            .then(function(browser) {
                return _this._runStates(browser, captureProcessor)
                    .fin(function() {
    ...
    _runStates: function(browser, captureProcessor) {
        ...
        function runStates_() {
            return promiseUtils.seqMap(_this._suite.states, function(state) {
                    return _this._runStateInSession(state, session, captureProcessor);
                });
        }
    ...
    _runStateInSession: function(state, session, captureProcessor) {
