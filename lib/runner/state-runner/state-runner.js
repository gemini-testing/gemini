...
var StateRunner = inherit(Runner, {
    ...
    run: function(captureProcessor) {
        ...
        return this._browserSession.runActions(this._state.actions)
            .then(function() {
                return _this._capture(captureProcessor);
            }, function(e) {
    ...
    _capture: function(captureProcessor) {
        var _this = this;
        return this._browserSession.capture(this._state, {coverage: _this._config.isCoverageEnabled()})
            .then(function(data) {
                var capture = _.extend(data, {
                    suite: _this._state.suite,
                    state: _this._state,
                    browser: _this._browserSession.browser
                });

                return captureProcessor.processCapture(capture)
                    .then(function(processed) {
                        _this.emit(PrivateEvents.STATE_RESULT, _.extend(processed, {
