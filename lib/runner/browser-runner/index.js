...
var BrowserRunner = inherit(Runner, {
    ...
    _runSuites: function(suites) {
        ...
        return _(suites)
            ...
            .map(function(suite) {
                return _this._tryToRunSuite(suite);
            })
            .thru(promiseUtils.waitForResults)
            .value();
    },

    _tryToRunSuite: function(suite) {
        var _this = this;

        return _this._runSuite(suite)
            .fail(function(e) {
    ...
    _runSuite: function(suite, browser) {
        var runner = SuiteRunner.create(this._config);
        ...
        return runner.run(suite, this._browserAgent);
    }
}, {
