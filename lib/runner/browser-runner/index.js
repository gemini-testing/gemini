...
var BrowserRunner = inherit(Runner, {
    ...
    _runSuites: function(suites, captureProcessor) {
        var _this = this;
        ...
        return _(suites)
            ...
            .map(function(suite) {
                return _this._tryToRunSuite(suite, captureProcessor);
            })
            .thru(promiseUtils.waitForResults)
            .value();
    },

    _tryToRunSuite: function(suite, captureProcessor) {
        var _this = this;

        return _this._runSuite(suite, captureProcessor)
            .fail(function(e) {
    ...
    _runSuite: function(suite, captureProcessor) {
