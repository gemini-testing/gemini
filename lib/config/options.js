...
module.exports = {
    ...
    tolerance: {
        map: function(value) {
            throw new GeminiError('"tolerance" setting was removed in gemini 0.8.0',
                'By default, gemini will treat all non-noticable difference as passed test.\n' +
                'Use "strictComparison" option to make it fail on all differences');
        }
    },
