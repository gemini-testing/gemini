...
module.exports = inherit(ScreenUpdater, {
    ...
    _doProcessCapture: function(capture, refPath) {
        return util.sequence([
            this._diffUpdater._doProcessCapture.bind(this._diffUpdater, capture, refPath),
            this._newUpdater._doProcessCapture.bind(this._newUpdater, capture, refPath)
        ]);
    }
});
