...
function Gemini(config, allowOverrides) {
    ...
    this.gather = util.deprecate(
        function(paths, options) {
            return run(
                StateProcessor.createScreenShooter(this.config),
                paths,
                options
            );
        },
    ...
    this.update = function(paths, options) {
        return run(
            StateProcessor.createScreenUpdater(this.config, options),
            paths,
            options
        );
    };
    ...
    this.test = function(paths, options) {
        return run(
            StateProcessor.createTester(this.config, {tempDir: options.tempDir}),
            paths,
            options
        );
    };
