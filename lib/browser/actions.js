...
module.exports = inherit({
    ...
    __constructor: function(browser, postActions) {
    ...
    setWindowSize: function(width, height) {
        ...
        this._pushAction(this.setWindowSize, function setWindowSize() {
            var promise = q();
            if (_this._postActions) {
                promise = _this._driver.getWindowSize();
            }
    ...
    performPostActions: function() {
        return this._postActions.perform();
    },
