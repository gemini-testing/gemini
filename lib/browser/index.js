...
var Browser = inherit({
    __constructor: function(config) {
        ...
        this._camera = new Camera(this._browser);
    ...
    _exposeWdApi: function(methods) {
        var _this = this;
        methods.forEach(function(method) {
            _this[method] = function() {
                return _this._browser[method].apply(_this._browser, arguments);
            };
        });
    },
            ...
            .then(function() {
                ...
                return calibrator.calibrate(_this)
                    .then(function(result) {
                        ...
                        _this._camera.calibrate(result);
                    });
            })
            .then(function() {
