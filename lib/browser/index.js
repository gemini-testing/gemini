...
module.exports = inherit({
    ...
    captureState: function(state, context) {
        ...
        return state.activate(this, context)
            .then(function() {
                return _this._captureElementsImage(state.captureSelectors);
            })
            .fail(function(e) {
                if (e instanceof StateError) {
                    ...
                    e.browserId = _this.id;
                }
                return q.reject(e);
            }); 
    },

    _captureElementsImage: function(selectors) {
        var _this = this;
        return  _this._prepareScreenshot(selectors)
            .then(function(data) {
                return _this._captureFulllscreenImage()
                    .then(function(image) {
    ...
    _prepareScreenshot: function(selectors) {
        /*jshint evil:true*/
    ...
    _captureFulllscreenImage: function() {
